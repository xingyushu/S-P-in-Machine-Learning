...
model = Net()
model.load_state_dict(torch.load('mnist_model_defense_045_2.pt'))
model.eval()
...
# plt.xlabel("Epsilon")
# plt.ylabel("Accuracy")
# plt.savefig('defense_test_accuracy_task2_with_Epsilon_001.pdf')
# plt.show()
...
# plt.tight_layout()
# plt.savefig('defense_examples_task2_005.pdf')
# plt.show()
